...
outputPath="Arc_collision_bdls_4e-5"
...
Model.surfaceProcesses = GEO.surfaceProcesses.Badlands(airIndex=[Air.index],sedimentIndex=sediment.index, XML="./ressources/badlands3.xml", resolution=4. * u.kilometer,restartFolder="outbdls", checkpoint_interval=0.2 * u.megayears,restartStep=156)
...
if restart==False:
    ...
    run_for_adaptative(Model,duration=(20.*MaUnit)*u.year,checkpoint_interval=(0.2*MaUnit)*u.year,dt=5000*u.years,restartDir=outputPath,restartStep=155)
